          ...
          <div className="sb-sidenav-menu">
            <div className="nav">
              ...
              <SideMenuHeading label="Interface"></SideMenuHeading>
                <SideNavLink label="Layouts" target="#collapseLayouts" controls="CollapseLayouts">
              ...
              <SideNavLink  label="Pages" target="#collapsePages" controls="CollapsePages">
                <div className="sb-nav-link-icon">
                  <i className="fas fa-columns"></i>
                </div>
              </SideNavLink>
              ...
              <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                  ...
                  <SideNavLink  label="Authentification " target="#pagesCollapseAuth"  controls="pagesCollapseAuth" />
                  
                  <InnerLink id="pagesCollapseAuth" href1="login.html" href2="Register" href3="password.html" label1="Login" label2="Register"
                    label3="Forgot Password"  />
                    
                  
                  <SideNavLink label="Error"  target="#pagesCollapseError"  controls="pagesCollapseError"  />
                  <InnerLink  id="pagesCollapseError"  href1="401.thml" href2="404.html" href3="500.html" label1="401 pages" label2="404 pages"
                  label3="500 pages" />
